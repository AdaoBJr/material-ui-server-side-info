...
import { StockProvider } from 'financiamento/bff/infra';
import { ProdutoDTO } from 'financiamento/bff/types/dto';
import { GetProdutoIdService } from 'financiamento/bff/types/response';
